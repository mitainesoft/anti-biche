...
//Prints html header
 void printHtmlHeader(EthernetClient client){
          ...
          // add page title 
          client.println(F("<title>Systeme Anti-Biche</title>"));
          client.println(F("<meta name=\"description\" content=\"System Anti-Biche2\"/>"));
...
int printSwitchTable(EthernetClient client)
{
  ...
  client.println(F("<h1><font size=\"30\" color=\"#191970\">Anti-Biche Systeme</font></h1>"));
